...
FocusScope {
    ...
    property var allCollections: {
        ...
        // collections.unshift({"name": "ps3", "shortName": "ps3", "games": collections[6].games})
        // collections.unshift({"name": "switch", "shortName": "switch", "games": collections[6].games})
        // collections.unshift({"name": "wiiware", "shortName": "wiiware", "games": collections[6].games})
    ...
    property variant dataConsoles: {
        ...
        "switch":           { manufacturer: "nintendo",             release: "2017",    color: "#000000", altColor: "#252525" },
        ...
        "ps3":              { manufacturer: "sony",                 release: "2006",    color: "#3144B1", altColor: "#00224C" },
