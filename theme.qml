...
FocusScope {
    ...
    property var dataText: {
       ...
       "ch": {
            ...
            settings_general_logoVariant_mono: "单声道",
            settings_general_logoVariant_color: "颜色",
            global_yes: "是",
            global_no: "否",
            ...
            settings_general_hideOSC: "隐藏控件",
            settings_general_dynamicFontScaling: "动态字体缩放",
            settings_general_OSCScheme: "控制方案",
            settings_global_backgroundImg: "Background image",
    ...
    property var dataConsoles: {
        "default":            { manufacturer: "various",       release: null,   color: "#000000", altColor: "#303030", altColor2: "#B8B8B8", fullName: "Default"   },
